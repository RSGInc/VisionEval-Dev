...
ReadPopulationSimOutput <- function(L){
  ...
  ve_hh_dt <- data.table(
    ...
    Bzone = syn_hh_dt[, BG],
    Azone = ve_geo_dt[,Azone][match(syn_hh_dt[,BG], ve_geo_dt$Bzone)],
    Marea = ve_geo_dt[,Marea][match(syn_hh_dt[,BG], ve_geo_dt$Bzone)],
  ...
  ve_per_dt <- data.table(
    ...
    Bzone = syn_per_dt[, BG],
    Azone = ve_geo_dt[,Azone][match(syn_per_dt[,BG], ve_geo_dt$Bzone)],
    Marea = ve_geo_dt[,Marea][match(syn_per_dt[,BG], ve_geo_dt$Bzone)]
  )
