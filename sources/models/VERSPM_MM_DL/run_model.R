...
for(Year in getYears()) {
  ...
  runModule("PredictHousing",                  "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
  runModule("LocateEmployment",                "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
  runModule("AssignLocTypes",                  "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
  runModule("Calculate4DMeasures",             "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
  runModule("CalculateUrbanMixMeasure",        "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
  runModule("AssignParkingRestrictions",       "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
  runModule("AssignDemandManagement",          "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
  runModule("AssignCarSvcAvailability",        "VELandUseDL",           RunFor = "AllYears",    RunYear = Year)
