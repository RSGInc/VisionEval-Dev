...
CalculateMpgMpkwhAdjustments <- function(L) {
  ...
  DriverlessDvmtProp_MaVt[,"Ldv"] <- L$Year$Marea$LdvAVLvl5Prop
  DriverlessDvmtProp_MaVt[,"HvyTrk"] <- 0#L$Year$Marea$HvyTrkDriverlessProp
  DriverlessDvmtProp_MaVt[,"Bus"] <- 0#L$Year$Marea$BusDriverlessProp
  ...
  DriverlessAdjParam_ <- (L$Global$AVLvl5EffectAdjParam$Beta)
  names(DriverlessAdjParam_) <- L$Global$AVLvl5EffectAdjParam$Measure
