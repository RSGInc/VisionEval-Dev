...
|12 |DeadheadProp         |double |multiplier |NA, < 0      |            |         |Proportion of vehicle DVMT that is deadhead mileage for level 5 autonomous vehicles                                                                                                                                                  |
|13 |RunTimeUtilityAdj    |double |multiplier |NA, < 0      |            |         |Adjustment factor that is used to adjust the travel time component of composite vehicle operating cost of level 5 autonomous vehicles                                                                                                |
|14 |AccessTimeUtilityAdj |double |multiplier |NA, < 0      |            |         |Adjustment factor that is used to adjust the access time component of composite vehicle operating cost of level 5 autonomous vehicles when vehicle access is remotely controlled.                                                    |
|15 |RemoteAccessDvmtAdj  |double |multiplier |NA, < 0      |            |         |Adjustment factor that specifies the proportional adjustment to level 5 autonomous vehicle DVMT assumed to occur as a result of remote vehicle access for convenience, avoiding parking, and/or avoiding/reducing parking charges.   |
|16 |PropRemoteAccess     |double |proportion |NA, < 0, > 1 |            |         |The proportion of trips in level 5 autonomous vehicles for which travelers use capabilities of driverless vehicles to remotely control their vehicles to avoid having to park their vehicle and retrieve their vehicle from parking. |
|17 |PropParkingFeeAvoid  |double |proportion |NA, < 0, > 1 |            |         |The proportion of parking fees avoided for travel in owned driverless vehicles.                                                                                                                                                      |
...
|DeadheadProp         |Region    |Year   |double    |multiplier |NA, < 0      |                           |
...
|IsAVLvl5DvmtAdjProp  |Household |Year   |double    |proportion |NA, < 0, > 1 |                           |
...
|DriverlessDvmtAdjProp |Household |Year  |double   |proportion |NA, < 0, > 1 |            |Proportion of total DVMT that is added based on level 5 autonomous vehicle driverless use  |
|DeadheadDvmtAdjProp   |Household |Year  |double   |proportion |NA, < 0, > 1 |            |Proportion of total DVMT that is the added deadhead mileage of level 5 autonomous vehicles |
