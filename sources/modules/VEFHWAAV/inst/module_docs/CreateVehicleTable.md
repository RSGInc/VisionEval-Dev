...
|ShdCarSvcDeadheadProp   |double   |proportion |NA, < 0      |            |> 1      |The deadhead proportion for shared car service calculated using deadhead mileage divided by fare mileage                                                                                           |
|UnShdCarSvcDeadheadProp |double   |proportion |NA, < 0      |            |> 1      |The deadhead proportion for unshared car service calculated using deadhead mileage divided by fare mileage                                                                                         |
